...
def create_prediction(df_test, X_train, y_train, X_test):
    ...
    solution.to_csv("results/solutions/nn_NIEUW" + str(date_time) + ".csv", index=False)
...
if __name__ == "__main__":
    ...
    df_test = pd.read_csv("data/test_prep_NEW2.csv")
    df_train = pd.read_csv("data/training_prep_NEW2.csv")
    ...
    predictors = [c for c in df_train.columns if c not in ["rank", "prop_id","srch_id","booking_bool",\
